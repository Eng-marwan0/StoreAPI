...
{
    /// <inheritdoc />
    public partial class marwan : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__AdminUse__719FE488929B46A5", x => x.AdminId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Categori__19093A0B38CB1BCB", x => x.CategoryId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Clinics__3347C2DD1C08433B", x => x.ClinicId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsageLimitGlobal = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Coupons__384AF1BA2232599D", x => x.CouponId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Offers__8EBCF09177A91712", x => x.OfferId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OTP__3143C4A30E10E75C", x => x.OtpId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Roles__8AFACE1AB73A0D98", x => x.RoleId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Shipping__DADC8FBA61A402ED", x => x.ShippingCompanyId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Users__1788CC4CEF6CFF0E", x => x.UserId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__AdminLog__5E548648BBC543DB", x => x.LogId);
                    table.ForeignKey(
                        name: "FK_AdminLogs_AdminUsers",
                        column: x => x.AdminId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Products__B40CC6CDFC4CD2FD", x => x.ProductId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Doctors__2DC00EBF7DD906CE", x => x.DoctorId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminUserRoles", x => new { x.AdminId, x.RoleId });
                    table.ForeignKey(
                        name: "FK_AdminUserRoles_AdminUsers",
                        column: x => x.AdminId,
                        principalTable: "AdminUsers",
                        principalColumn: "AdminId");
                    table.ForeignKey(
                        name: "FK_AdminUserRoles_Roles",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Carts__51BCD7B7303578F0", x => x.CartId);
                    table.ForeignKey(
                        name: "FK_Carts_Users",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__UserAddr__091C2AFB8076F283", x => x.AddressId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OfferProducts_Offers",
                        column: x => x.OfferId,
                        principalTable: "Offers",
                        principalColumn: "OfferId");
                    table.ForeignKey(
                        name: "FK_OfferProducts_Products",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ProductI__7516F70CACD2902B", x => x.ImageId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingTime = table.Column<TimeOnly>(type: "time(0)", precision: 0, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Bookings__73951AED05B6916C", x => x.BookingId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxBookingsPerSlot = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__DoctorSc__9C8A5B498198651B", x => x.ScheduleId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceAtTime = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__CartItem__488B0B0A0F973C79", x => x.CartItemId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Orders__C3905BCF38BC5CF5", x => x.OrderId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    OrderId = table.Column<int>(type: "int", nullable: false),
                    UsedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "(sysutcdatetime())")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__CouponUs__10AE105D5AFA5B04", x => x.CouponUsageId);
                    table.ForeignKey(
                        name: "FK_CouponUsages_Coupons",
                        column: x => x.CouponId,
                        principalTable: "Coupons",
                        principalColumn: "CouponId");
                    table.ForeignKey(
                        name: "FK_CouponUsages_Orders",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "OrderId");
                    table.ForeignKey(
                        name: "FK_CouponUsages_Users",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OrderIte__57ED068188F4C995", x => x.OrderItemId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingCost = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Shipment__5CAD37ED11B68E1E", x => x.ShipmentId);
                    table.ForeignKey(
                        ...
                        principalColumn: "OrderId");
                    table.ForeignKey(
                        name: "FK_Shipments_ShippingCompanies",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__AdminUse__A9D1053492F476B3",
                table: "AdminUsers",
                column: "Email",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Carts__1788CC4DADD8E7E1",
                table: "Carts",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Coupons__A25C5AA77B4A708A",
                table: "Coupons",
                column: "Code",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Orders__CAC5E743C9AF0F1F",
                table: "Orders",
                column: "OrderNumber",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Roles__737584F68F1B470B",
                table: "Roles",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Users__5C7E359EF18E8DFB",
                table: "Users",
                column: "Phone",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Users__A9D105344D4C7D4A",
                table: "Users",
                column: "Email",
                unique: true,
